...
date: 2023-11-02T02:31:00Z
tags: ['intel management engine', 'security', 'firmware', 'asus', 'vivobook', 'hardware', 'workstation', 'laptop', 'desktop']
draft: false
...
<div class="flex justify-center items-center">
  <figure>
    ...
    <figcaption class="flex justify-center text-xs italic">Almost as good as Apple M1 Max!</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    ...
    <figcaption class="flex justify-center text-xs italic">This system is vulnerable</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    ...
    <figcaption class="flex justify-center text-xs italic">Intel Security update included</figcaption>
  </figure>
</div>
