...
Looks like this issue has been fixed in BIOS version 306. I've updated my laptop and the latest Intel CSME tool (version 9.0.0.3) no longer reports any vulnerabilities.
