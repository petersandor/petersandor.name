...
<div tabIndex={0} className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box not-prose">
  <div className="collapse-title text-lg font-medium">
    Laptop specifications
  </div>
  <div className="collapse-content text-content2">
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              Performance Cores: 4 Cores, 8 Threads, 2.5 GHz Base, 4.5 GHz Turbo
          ...
          <tr>
            ...
            <td>
              8GB DDR4 on board
              8GB DDR4 SO-DIMM <em>(I had to buy and install this one though)</em>
            </td>
          </tr>
          <tr>
            <td>Storage</td>
          ...
          <tr>
            <td>Graphics</td>
            <td>
              Intel UHD / Intel Iris Xe 80EU <em>(when in dual channel mode)</em>
            </td>
          </tr>
          <tr>
            <td>Display</td>
