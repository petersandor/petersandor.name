...
var config = {
  scripts: [
    ...
    'js/libs/jquery.address-1.6.min.js',
    'js/libs/triple.layout.js',
    'js/libs/smoothscroll.js',
    'js/libs/nprogress/nprogress.js',
    ...
    'js/libs/jquery.fancybox-1.3.4.pack.js',
  ...
  styles: [
    ...
    'js/libs/google-code-prettify/prettify.css',
